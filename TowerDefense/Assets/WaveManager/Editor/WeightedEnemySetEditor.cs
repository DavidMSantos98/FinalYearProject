...
public class WeightedEnemySetEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        for (int i = 0; i < myTarget.enemies.Count; i ++)
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("enemies").GetArrayElementAtIndex(i).FindPropertyRelative("spawn"));
            EditorGUILayout.PropertyField(serializedObject.FindProperty("enemies").GetArrayElementAtIndex(i).FindPropertyRelative("weight"));
