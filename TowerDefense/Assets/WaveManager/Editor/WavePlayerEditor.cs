...
public class WavePlayerEditor : Editor
{
    ...
    public void OnSceneGUI()
    {
        ...
        {
            Vector3 a = (!myTarget.spawnAtObject | myTarget.spawnObject == null) ? myTarget.spawnlocation : myTarget.spawnObject.transform.position;
    ...
    public void drawSpawnSettings ()
    {
        ...
        else
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("spawnObject"), GUIContent.none);
        }
        GUILayout.EndHorizontal();
